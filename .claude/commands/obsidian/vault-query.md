...
- **vault 경로**: `~/Library/Mobile Documents/iCloud~md~obsidian/Documents/chan99k's vault/chan99k's vault/`
...
1. **TDD 실무 가이드** (유사도: 0.8542)
   - 경로: 03-Resources/TDD/TDD-Best-Practices.md
   - 태그: #tdd #testing #practices
   - 미리보기: 테스트 주도 개발의 실무 적용 방법과 모범 사례...

2. **클린 코더스 TDD 강의** (유사도: 0.7234)
   - 경로: 03-Resources/VIDEOS/Clean-Coders-TDD.md
