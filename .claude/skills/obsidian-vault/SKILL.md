...
description: |
  ...
  Obsidian, vault, 마크다운, 태그, 노트 정리, PARA, 백링크, wiki-link, PKM 관련 작업 시 자동 적용.
---
...
| _attachments, _templates, _excalidraw | 유틸리티 | 읽기/쓰기 |
...
# ✅ 효율적
"03-Resources에서 'kubernetes' 태그가 있는 노트 목록만 보여줘"
```
